...
VALUES
  ('midnight-oud','Midnight Oud','Eau de Parfum Â· 50ml','A meditative composition of Assam oud aged 18 years, smoked cedar and black amber.','Oud',ARRAY['Bergamot','Pink Pepper'],ARRAY['Assam Oud','Rose Absolute'],ARRAY['Amber','Sandalwood','Vetiver'],12500,15000,50,24,'/src/assets/product-1.jpg',4.9,128,true,false,(SELECT id FROM public.collections WHERE slug='oud-reserve')),
  ('rose-taif','Rose Taif','Eau de Parfum Â· 50ml','The legendary Taif rose petals distilled with Kannauri jasmine and a whisper of saffron.','Floral',ARRAY['Saffron','Pink Pepper'],ARRAY['Taif Rose','Jasmine Sambac'],ARRAY['White Musk','Sandalwood'],9800,NULL,50,40,'/src/assets/product-2.jpg',4.8,96,true,false,(SELECT id FROM public.collections WHERE slug='royal-florals')),
  ('amber-noir','Amber Noir','Extrait de Parfum Â· 30ml','Warm amber wrapped in tonka bean, vanilla absolute and Peruvian balsam.','Amber',ARRAY['Cardamom','Bergamot'],ARRAY['Amber','Tonka Bean'],ARRAY['Vanilla','Benzoin','Musk'],11200,13500,30,18,'/src/assets/product-3.jpg',4.9,74,true,true,(SELECT id FROM public.collections WHERE slug='spiced-orient')),
  ('cambodi-attar','Cambodi Attar','Pure Attar Â· 12ml','Traditional Cambodian oud attar distilled in copper degs. Sweet, resinous, transcendent.','Attar',ARRAY['Aged Oud'],ARRAY['Sandalwood','Musk'],ARRAY['Deer Musk','Resin'],18500,NULL,12,8,'/src/assets/product-4.jpg',5.0,52,false,true,(SELECT id FROM public.collections WHERE slug='rare-attars')),
...
('the-soul-of-oud',
 ...
 E'# The Soul of Oud\n\nFew ingredients carry the mystique of oud. Formed only when Aquilaria trees are wounded and infected with a rare mould, the resulting resin â€” agarwood â€” is distilled into an oil more precious than gold by weight.\n\n## Origins\n\nOur master perfumers source oud from three legendary regions: **Assam** for its leathery depth, **Cambodia** for smoky sweetness, and **Trat** for animalic warmth. Each vintage is aged for a minimum of seven years.\n\n## The Craft\n\nEvery drop passes through a hydro-distillation process refined over centuries. The result is a fragrance with unparalleled longevity â€” a signature that becomes uniquely yours as it develops on the skin.\n\n> "Oud is not worn. It is inhabited." â€” Mystique Atelier',
...
INSERT INTO public.site_settings (key, value) VALUES (
  ...
  '{
    "announcements": [
      "Complimentary shipping across India on orders above â‚¹5,000",
      "Discover our new Oud Reserve collection â€” hand-poured in Kannauj",
      "Bespoke gift boxes with hand-written inscriptions"
    ],
    "hero": {
      "eyebrow": "Maison Mystique Â· Est. 2019",
      "title": "The alchemy of scent, distilled.",
      "subtitle": "Rare oud, aged attars, and modern compositions â€” crafted in small batches for those who wear fragrance as a signature.",
    ...
    "brandStory": {
      ...
      "body": "From Assam agarwood to Kannauj rose, every ingredient is sourced at origin and aged for years before it meets the bottle. Our perfumers compose in the tradition of the great Eastern attar houses â€” patient, precise, uncompromising."
    },
    "newsletter": {
